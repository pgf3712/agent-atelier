...
[Leer en español](README.es.md) · [Learning path](docs/CHAPTER_MATRIX.md) · [Architecture](docs/architecture/overview.md) · [Interview guide](docs/INTERVIEW_GUIDE.md)
...
- Click **Paula** for a deeper technical notebook: the mental model, file connections, pitfalls and a 30-second interview answer.
...
|---|---|
| ![Paula's technical notebook connecting the chapter concept to files, mistakes and an interview answer](docs/images/paula-technical-notebook.png) | ![Indy's contextual hint shown beside the active code workshop](docs/images/indy-contextual-hint.png) |
| Paula explains how the pieces connect and turns the lesson into language the learner can defend in an interview. | Indy starts with a small contextual hint. The exact answer stays hidden behind a second deliberate action. |
...
| Opens deeper explanations, code connections, pitfalls and interview language. | Offers a small hint first and reveals an answer only when the learner requests it. |
...
docs/                architecture, ADRs, interview and release material
assets/              original characters, background and procedural audio
```

## A two-minute recruiter tour
...
The longer discussion is prepared in [How to discuss Agent Atelier in an interview](docs/INTERVIEW_GUIDE.md).
