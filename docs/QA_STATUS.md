...
- Paula exposes one next action at a time. Clicking her opens a chapter-specific technical notebook with the mental model, concrete example, common pitfall, file connections and a 30-second interview answer.
