...
|---|---|
| ![Cuaderno técnico de Paula conectando el concepto con archivos, errores y un resumen basado en evidencias](docs/images/paula-technical-notebook.png) | ![Pista contextual de Indy junto al taller de código activo](docs/images/indy-contextual-hint.png) |
| Paula explica cómo se conectan las piezas y condensa la lección en un resumen técnico basado en evidencias. | Indy empieza con una pista pequeña. La respuesta exacta permanece oculta tras una segunda acción deliberada. |
...
- `docs/architecture/`: arquitectura y límites técnicos del sistema.
